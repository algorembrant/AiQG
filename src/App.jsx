...
const ALL_LLMS = [
  ...
  { id: 'vicuna', name: 'Vicuna', url: 'https://chat.lmsys.org/', icon: 'https://th.bing.com/th/id/ODF.HX1F6ABunv1ieMmqjCr7LQ?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Open Source' },
  { id: 'wizardlm', name: 'WizardLM', url: 'https://github.com/nlpxucan/WizardLM', icon: 'https://github.com/nlpxucan/WizardLM/raw/main/imgs/WizardLM.png', category: 'Open Source' },
  ...
  { id: 'step', name: 'StepChat', url: 'https://stepchat.cn/', icon: 'https://ai-bot.cn/wp-content/uploads/2024/03/stepchat-icon.png', category: 'Chinese' },
  { id: 'yuanbao', name: 'Yuanbao', url: 'https://yuanbao.tencent.com/', icon: 'https://www.bing.com/th/id/OIP.4t0oXJWUxo0NeKNFug9KWAAAAA?w=166&h=211&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2', category: 'Chinese' },
  { id: 'baichuan', name: 'Baichuan', url: 'https://www.baichuan-ai.com/', icon: 'https://www.bing.com/th/id/OIP.VHEw_-Xll0Ac2_LSHK_dRwHaHa?w=188&h=211&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2', category: 'Chinese' },
  { id: 'skywork', name: 'Skywork', url: 'https://www.kunlun-inc.com/', icon: 'https://img.seektool.ai/2025/07/22/skywork-ai-home-logo.png', category: 'Chinese' },
  { id: 'aquilachat', name: 'AquilaChat', url: 'https://model.baai.ac.cn/model-detail/100098', icon: 'https://assets-global.website-files.com/62c72c77b482b372ac273024/64a26b9c8cc4c3b2cddeb8bb_Aquila.png', category: 'Chinese' },
  { id: 'moss', name: 'MOSS', url: 'https://moss.fastnlp.top/', icon: 'https://www.bing.com/th/id/OIP.BDnuPXtgOk7uBIF4lNLpNQHaD4?w=217&h=211&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2', category: 'Chinese' },
  { id: 'ziya', name: 'Ziya-LLaMA', url: 'https://huggingface.co/IDEA-CCNL/Ziya-LLaMA-13B-v1', icon: 'https://github.com/IDEA-CCNL/Fengshenbang-LM/raw/main/pics/all_models.png', category: 'Chinese' },
  ...
  { id: 'windsurf', name: 'Windsurf', url: 'https://codeium.com/windsurf', icon: 'https://th.bing.com/th/id/ODF.6EhekcoQt58d76Y3DAJRFQ?w=32&h=32&qlt=90&pcl=fffffc&o=6&pid=1.2', category: 'Coding' },
  { id: 'continue', name: 'Continue', url: 'https://continue.dev/', icon: 'https://th.bing.com/th/id/ODF.aRQOZw6_veyl7K33fQZ_Yg?w=32&h=32&qlt=90&pcl=fffffc&o=6&pid=1.2', category: 'Coding' },
  { id: 'phind-code', name: 'Phind AI', url: 'https://www.phind.com/', icon: 'https://th.bing.com/th/id/ODF.wRVGXkARu0kzLLBhplGWlg?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Coding' },
  { id: 'blackbox', name: 'Blackbox AI', url: 'https://www.blackbox.ai/', icon: 'https://th.bing.com/th/id/ODF.MzVnOSaAftpc9Vqv-_3s1A?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Coding' },
  { id: 'codegpt', name: 'CodeGPT', url: 'https://codegpt.co/', icon: 'https://th.bing.com/th/id/ODF.4p001fg9KpAXZdx5VNxdHA?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Coding' },
  { id: 'aicode', name: 'aiXcoder', url: 'https://www.aixcoder.com/', icon: 'https://th.bing.com/th/id/ODF.Li_Hg1uXZ_IKCOFUFKlHQg?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Coding' },
  { id: 'mintlify', name: 'Mintlify', url: 'https://mintlify.com/', icon: 'https://th.bing.com/th/id/ODF.Wne2W_VWDhp2pdNe_0AEUQ?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Coding' },
  { id: 'codepal', name: 'CodePal', url: 'https://codepal.ai/', icon: 'https://th.bing.com/th/id/ODF.RI7M9BpHQhTtFo6LVMg5Gg?w=32&h=32&qlt=91&pcl=fffffa&o=6&pid=1.2', category: 'Coding' },
  ...
  { id: 'kling', name: 'Kling AI', url: 'https://klingai.com/', icon: 'https://th.bing.com/th/id/ODF.GRNF1cf0IvJs2S5VupIeng?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Creative' },
  { id: 'luma', name: 'Luma Dream Machine', url: 'https://lumalabs.ai/', icon: 'https://www.gadgety.co.il/wp-content/themes/main/thumbs/2024/06/luma-ai-logo.jpg', category: 'Creative' },
  { id: 'veo', name: 'Google Veo', url: 'https://deepmind.google/technologies/veo/', icon: 'https://th.bing.com/th/id/ODF.s1T-rGYbeWOywKjL6mh1iA?w=32&h=32&qlt=93&pcl=fffffa&o=6&pid=1.2', category: 'Creative' },
  { id: 'genmo', name: 'Genmo', url: 'https://www.genmo.ai/', icon: 'https://th.bing.com/th/id/ODF.meAKK3mG1ujFcrC2JEoJeQ?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Creative' },
  { id: 'civitai', name: 'CivitAI', url: 'https://civitai.com/', icon: 'https://th.bing.com/th/id/ODF.guCR5dfsMbiL4DhV4RU5hw?w=32&h=32&qlt=90&pcl=fffffc&o=6&pid=1.2', category: 'Creative' },
  { id: 'artbreeder', name: 'Artbreeder', url: 'https://www.artbreeder.com/', icon: 'https://th.bing.com/th/id/ODF.9TkvVzTLz_oEx7sn92FQDQ?w=32&h=32&qlt=90&pcl=fffffc&o=6&pid=1.2', category: 'Creative' },
  { id: 'craiyon', name: 'Craiyon', url: 'https://www.craiyon.com/', icon: 'https://th.bing.com/th/id/ODF.FYS5SzVamMTnqMZ-eutRMQ?w=32&h=32&qlt=90&pcl=fffffc&o=6&pid=1.2', category: 'Creative' },
  { id: 'deepai', name: 'DeepAI', url: 'https://deepai.org/', icon: 'https://th.bing.com/th/id/ODF.ok5a5qPe-Y1r53E0cpUSYQ?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Creative' },
  ...
  { id: 'haystack', name: 'Haystack', url: 'https://haystack.deepset.ai/', icon: 'https://th.bing.com/th/id/ODF.LCiMc6mzdR453eHwMvLiJw?w=32&h=32&qlt=90&pcl=fffffc&o=6&pid=1.2', category: 'Developer' },
  { id: 'semantic-kernel', name: 'Semantic Kernel', url: 'https://github.com/microsoft/semantic-kernel', icon: 'https://avatars.githubusercontent.com/u/6154722?s=48&v=4', category: 'Developer' },
  { id: 'autogen', name: 'AutoGen', url: 'https://microsoft.github.io/autogen/', icon: 'https://th.bing.com/th/id/ODF.NDEAdNEyWkHmaSYf_31idQ?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Developer' },
  { id: 'langfuse', name: 'Langfuse', url: 'https://langfuse.com/', icon: 'https://th.bing.com/th/id/ODF.du8EmLZrNgh8Tvryy-5GSQ?w=32&h=32&qlt=90&pcl=fffffc&o=6&pid=1.2', category: 'Developer' },
  { id: 'helicone', name: 'Helicone', url: 'https://www.helicone.ai/', icon: 'https://th.bing.com/th/id/ODF.l61UzTBT27rtw2_OTb0slw?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Developer' },
  { id: 'promptlayer', name: 'PromptLayer', url: 'https://promptlayer.com/', icon: 'https://th.bing.com/th/id/ODF.CZAcaToTrU-8wcCovExfGw?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2', category: 'Developer' },
